...
export const CART = {
    ...
    REMOVE_ITEM: 'CART_ADD_ITEM',
    ITEM_INCREMENT: 'CART_INCREMENT',
    ITEM_DECREMENT: 'CART_ITEM_DECREMENT',
    SHIPPING_OPTION: 'CART_SHIPPING_OPTION',
    PAYMENT_OPTION: 'CART_PAYMENT_OPTION',
    DELETE_ALL: 'CART_DELETE_ALL'
}
